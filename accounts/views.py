...
def register(request):
    ...
    if request.method == 'POST':
        ...
        # if everything is okay Create a User
                    ...
                    send_mail(
                        'Welcome to DevBook!',
                        '<h1>Thank you for registering to DevBook.</h1><h1>DevBook is a Social media platform that allows you to interact with other developers. Ask for help, help others, and make connections!</h1>',
