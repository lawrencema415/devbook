# Generated by Django 2.2.4 on 2019-08-10 21:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_posted', models.DateTimeField(default=datetime.datetime(2019, 8, 10, 21, 53, 12, 860240))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('body', models.CharField(default='', max_length=500)),
                ('time_posted', models.DateTimeField(default=datetime.datetime(2019, 8, 10, 21, 53, 12, 860750))),
