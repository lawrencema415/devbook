    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_posted', models.DateTimeField(default=datetime.datetime(2019, 8, 12, 2, 34, 48, 965392))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_posted', models.DateTimeField(default=datetime.datetime(2019, 8, 12, 2, 34, 48, 968680))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('body', models.CharField(default='', max_length=500)),
                ('time_posted', models.DateTimeField(default=datetime.datetime(2019, 8, 12, 2, 34, 48, 965885))),
