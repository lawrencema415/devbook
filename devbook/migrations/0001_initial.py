# Generated by Django 2.2.4 on 2019-08-09 16:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_posted', models.DateTimeField(default=datetime.datetime(2019, 8, 9, 16, 58, 5, 982571))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('body', models.CharField(default='', max_length=500)),
                ('time_posted', models.DateTimeField(default=datetime.datetime(2019, 8, 9, 16, 58, 5, 983060))),
