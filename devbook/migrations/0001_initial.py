    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_posted', models.DateTimeField(default=datetime.datetime(2019, 8, 12, 1, 57, 7, 110015))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_posted', models.DateTimeField(default=datetime.datetime(2019, 8, 12, 1, 57, 7, 113249))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('body', models.CharField(default='', max_length=500)),
                ('time_posted', models.DateTimeField(default=datetime.datetime(2019, 8, 12, 1, 57, 7, 110498))),
